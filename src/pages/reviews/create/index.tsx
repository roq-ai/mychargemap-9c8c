...
import { getChargingStations } from 'apiSdk/charging-stations';
...
function ReviewCreatePage() {
  ...
  const formik = useFormik<ReviewInterface>({
    initialValues: {
      ...
      charging_station_id: (router.query.charging_station_id as string) ?? null,
    },
