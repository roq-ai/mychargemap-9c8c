...
CREATE TABLE "charging_station" (
    ...
    "description" VARCHAR(255),
    "charging_ports" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "review" ADD CONSTRAINT "review_charging_station_id_fkey" FOREIGN KEY ("charging_station_id") REFERENCES "charging_station"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
